package com.vortest;//import cucumber.api.Scenario;
...
//    }
//
//    public void createDatabaseConnectionList()
//    {
//        set("databaseConnections", (E) new ArrayList<Connection>());
//    }
//
//    public void storeDatabaseConnection(Connection connection)
//    {
//        List<Connection> connections = (List<Connection>) get("databaseConnections");
//        connections.add(connection);
//        set("databaseConnections", (E) connections);
//    }
//
//    public void closeDatabaseConnections() {
//        ArrayList<Connection> connections = (ArrayList<Connection>) get("databaseConnections");
//        for (Connection conn : connections) {
//            System.out.println("Closing open DB connection.");
//             DbUtils.closeQuietly(conn);
//        }
//
//        remove("databaseConnections");
//    }
